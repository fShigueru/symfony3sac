...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('jquery' => array(0 => array(0 => ($this->targetDirs[3].'/app/Resources/public/js/jquery.js')), 1 => array(), 2 => array()), 'bootstrap' => array(0 => array(0 => ($this->targetDirs[3].'/app/Resources/public/js/bootstrap.min.js')), 1 => array(), 2 => array()), 'bootstrap_css' => array(0 => array(0 => ($this->targetDirs[3].'/app/Resources/public/css/bootstrap.min.css')), 1 => array(), 2 => array()), 'angular' => array(0 => array(0 => ($this->targetDirs[3].'/app/Resources/public/js/angular.min.js')), 1 => array(), 2 => array()), 'angular_init' => array(0 => array(0 => ($this->targetDirs[3].'/app/Resources/public/js/angular/app.js')), 1 => array(), 2 => array()), 'angular_http_post' => array(0 => array(0 => ($this->targetDirs[3].'/app/Resources/public/js/angular/service/postService.js')), 1 => array(), 2 => array()))), 'config');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SacBundle', ($this->targetDirs[3].'/app/Resources/SacBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SacBundle', ($this->targetDirs[3].'/src/SacBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'uglifyjs2' => 'assetic.filter.uglifyjs2', 'uglifycss' => 'assetic.filter.uglifycss', 'scssphp' => 'assetic.filter.scssphp'));
    }
    ...
    protected function getAssets_PackagesService()
    {
        ...
        return $this->services['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', $b, $a), array('app' => new \Symfony\Component\Asset\PathPackage('/bundles/app/', $b, $a), 'img' => new \Symfony\Component\Asset\PathPackage('/bundles/app/images/', $b, $a), 'img_home' => new \Symfony\Component\Asset\PathPackage('/bundles/app/images/home/', $b, $a), 'fonts' => new \Symfony\Component\Asset\PathPackage('/bundles/app/fonts/', $b, $a), 'img_commom' => new \Symfony\Component\Asset\PathPackage('/bundles/admincommon/images/', $b, $a), 'liip' => new \Symfony\Component\Asset\PathPackage('/media/cache/', $b, $a), 'local' => new \Symfony\Component\Asset\PathPackage('/media/local/', $b, $a)));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sac_longevo', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/SacBundle/Entity'))), 'SacBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('SacBundle' => 'SacBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6be8e80b77aefd35bb0f490d8995d00edd6f10ca0fd0964a5b882bcd40e083ba');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \SacBundle\Service\SacService A SacBundle\Service\SacService instance
     */
    protected function getSac_Service_SacService()
    {
        return $this->services['sac.service.sac'] = new \SacBundle\Service\SacService($this->get('doctrine.orm.default_entity_manager'), $this->get('translator.default'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'AppBundle', 1 => 'SacBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SacBundle/Resources/views'), 'Sac');
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), ($this->targetDirs[3].'/app/Resources/public/images/'), true);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.read_from' => ($this->targetDirs[3].'/app/Resources/public/images/'),
            'assetic.write_to' => ($this->targetDirs[3].'/app/../web/static/'),
