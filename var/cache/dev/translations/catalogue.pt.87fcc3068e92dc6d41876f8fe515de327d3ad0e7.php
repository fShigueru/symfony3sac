...
$catalogue = new MessageCatalogue('pt', array (
  ...
  array (
    ...
    'msg.error.pedido.existe' => 'Pedido não existe!',
    'msg.error.pedido.num.existe' => 'O número do pedido não foi enviado.',
    'title.numero.pedido' => 'Número do pedido',
    'btn.verificar' => 'Verificar',
    'title.title' => 'Título',
    'title.observacao' => 'Observação',
    'title.enviar' => 'Enviar',
    'title.nome' => 'Nome',
    'title.email' => 'E-mail',
